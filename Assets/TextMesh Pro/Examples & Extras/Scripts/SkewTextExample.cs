    ...
    public class SkewTextExample : MonoBehaviour
    {
        ...
        IEnumerator WarpText()
        {
            ...
            while (true)
            {
                ...
                float boundsMinX = m_TextComponent.bounds.min.x;  //textInfo.meshInfo[0].mesh.bounds.minDeg.x;
                float boundsMaxX = m_TextComponent.bounds.max.x;  //textInfo.meshInfo[0].mesh.bounds.maxDeg.x;
